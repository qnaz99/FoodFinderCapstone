...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* <Image source={Icon.logo} style={{width: 100, height: 100}} /> */}
      <ImageBackground source="https://14thlane.ro/files/pages/1/OurStory2.webp" resizeMode="cover" style={styles.image}>
        ...
        <View style={styles.button}>
          <TouchableOpacity  onPress={() => alert('Error connecting to Google SSO Login API')} style={{backgroundColor:'white', borderRadius: 9, height:Dimensions.get('window').height * 0.06 }}>
